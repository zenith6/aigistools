...
// [begin...end)
var periods = [
  ['2015/04/16 15:00:00', '2015/04/23 10:00:00'],
  ['2015/04/23 15:00:00', '2015/04/30 10:00:00']
].map(function (period) {
...
var maps = [
  ...
  },
  {
    ...
    expectation: 11,
    drops: [
      {name: '封印の札3', icon: 'sealing-talisman-3', set: 3},
      {name: '封印の札1', icon: 'sealing-talisman-1', set: 2},
      {name: 'カゲロウ', icon: 'kagerou'},
      {name: 'プラチナアーマー', icon: 'platinum-bucket'}
    ]
  },
  {
    name: '妖怪封じの要石',
    ...
    expectation: 5,
    drops: [
      {name: '封印の札3', icon: 'sealing-talisman-3', set: 1},
      {name: '封印の札1', icon: 'sealing-talisman-1', set: 2},
      {name: 'ハリッサ', icon: 'harissa'},
      {name: 'ヴァレリー', icon: 'valerie'}
    ]
  },
  {
    name: '疾風の刃',
